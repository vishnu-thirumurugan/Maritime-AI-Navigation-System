...
def get_y_e_HE(ip,wp_k,wp_k_1):
    ...
    #############################
    lbp            = 3                  # Length between perpendicular
...
def activate(ip,wpA,H):
    ...
    if End_flag == False:
        ...
        if wp_near == len(SP)-1:
            H       = [H[0]+1,0,HE_old,ye_old,Goal] 
       
        elif wp_near >= H[1] and wp_near < len(SP)-1:
            H       = [H[0],wp_near+1,HE_old,ye_old,Goal] 
        
        elif wp_near < H[1]:
            H       = [H[0],H[1],HE_old,ye_old,Goal]
            
    elif End_flag == True:
        H = [H[0],len(S_prp[-1])-1,HE_old,ye_old,Goal]
